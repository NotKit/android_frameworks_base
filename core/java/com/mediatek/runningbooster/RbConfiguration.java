...
/**
 * A class representing a configured DuraSpeed settings, including adj valye, recent number,
 * notification number, checkLocationServiceApp, enableLauncherWidget, whiteList,
 * SuppressionPoint, enableRunningBooster and black list.
 */
public class RbConfiguration implements Parcelable {
    ...
    */
    ...
    /**
    * A tag to direct that RunningBoosterService when to do suppression.
    */
    ...
    /**
    * A list to save App's configuration which allow to use RunningBoosterService.
    */
