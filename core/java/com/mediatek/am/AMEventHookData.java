...
public class AMEventHookData {
    ...
    /**
     * Data type when AM_StartProcessForActivity happened.
     */
    public static class StartProcessForActivity extends AMEventHookDataManager {
        /**
         * Data.
         */
        public enum Index {
         ...
         * @return The instance of the data
         */
        public static StartProcessForActivity createInstance() {
            synchronized (StartProcessForActivity.class) {
                return new StartProcessForActivity();
            }
        }
