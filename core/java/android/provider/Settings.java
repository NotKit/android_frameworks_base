...
public final class Settings {
    ...
    public static final class Secure extends NameValueTable {
		...
		//guohuajun add GEMINI_CALLMODE_OPEN
		public static final String KEYCODE_COVER = "gemini_keycode_cover";
		
		//guohuajun add GEMINI_CALLMODE_OPEN
		public static final String GEMINI_CALLMODE_OPEN = "gemini_callmode_open";
        /**
        ...
        public static final String[] SETTINGS_TO_BACKUP = {
			...
			KEYCODE_COVER,
			GEMINI_CALLMODE_OPEN //guohuajun add
        };
