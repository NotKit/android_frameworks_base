...
interface ITelephonyEx {
  ...
  /**
   ...
   /**
     * Set the Pseudo Bs feature on.
      * @param slotId.
     * @param reportOn true for URC report on and false for URC report off
     * @param reportRateInMinutes times in minutes for report rate, must in 1 - 65535
     */
   void enablePseudoBSMonitor(int slotId, boolean reportOn, int reportRateInMinutes);

    /**
     * Set the Pseudo Bs feature off.
     * @param slotId.
     */
    void disablePseudoBSMonitor(int slotId);

    /**
     * Get all detected Pseudo Bs Records.
     * @return all detected Pseudo Bs Infos.
     */
    List<PseudoBSRecord> queryPseudoBSRecords(int slotId);

    /**
     * Enable or disable Telephony and connectivity debug log
     * @param enable true: enable log, false: disable log
     */
    void setTelLog(boolean enable);
}
