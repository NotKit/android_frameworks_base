...
// M: [LTE][Low Power][UL traffic shaping] End
  ...
  /**
    ...
    */
    ...
    public static final String ACTION_PCO_STATUS
            = "com.mediatek.intent.action.ACTION_PCO_STATUS";
    ...
    */
    ...
    public static final String ACTION_RADIO_STATE_CHANGED =
            "android.intent.action.RADIO_STATE_CHANGED";

    /**
     * Broadcast Action: Occurs when pseudo bs was detected.
     * The intent will have the following extra values:</p>
     * <ul>
     * <li><em>phoneId</em> - Phone ID</li>
     * <li><em>pseudoInfo</em> - 1 or 2 pseudo records.
     *      Sample:
     *     <type><plmn><lac><cid><arfcn><bsic>[<type><plmn><lac><cid><arfcn><bsic>]
     * </ul>
     */
    public static final String ACTION_PSEUDO_BS_DETECTED
        = "android.intent.action.ACTION_PSEUDO_BS_DETECTED";
